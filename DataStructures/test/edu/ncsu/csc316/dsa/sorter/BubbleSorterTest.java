...
/**
 * Test cases for BubbleSorter that tests that its functionality is correct.
 * 
...
public class BubbleSorterTest {
	...
	/** Initiates the BubbleSorter class and creates an object. */
	@SuppressWarnings("rawtypes")
	private BubbleSorter bubbleSorter;

	/**
	 * The set up for the test methods that initiates the BubbleSorter class.
	 */
	@SuppressWarnings("rawtypes")
	@Before
	public void setUp() {
